(function() {
    ...
    const CONFIG = {
        ...
        animeGenreId: '16', // Жанр аниме в TMDB
        pluginName: 'custom_anime_plugin',
        defaultEnabled: true,
    ...
    function createMenuItem() {
        ...
        menuItem.on('hover:enter', () => {
            loadContent({
                ...
                with_genres: CONFIG.animeGenreId
            });
        });
    ...
    function loadContent(params) {
        ...
        // Правильные параметры для TMDB API
        const queryParams = {
            ...baseParams,
            ...params,
        ...
        Lampa.Activity.push(queryParams);
    }
    ...
    function setupSettings() {
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                name: Lampa.Lang.translate('custom_anime_title'),
                description: "Включить кастомный раздел Аниме"
            },
            onChange: (value) => {

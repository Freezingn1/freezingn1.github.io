(function(Plugin) {
    ...
    Plugin.title = 'Аниме2';
    Plugin.version = '1.0';
    Plugin.description = 'Подборки аниме из TMDB';
    Plugin.route = '/anime2';
    Plugin.order = 10; // Порядок в боковом меню
    
    // Иконка для меню (можно заменить на свою)
    Plugin.icon = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/><circle cx="8.5" cy="10.5" r="1.5"/><circle cx="15.5" cy="10.5" r="1.5"/><path d="M12 17c2.76 0 5-2.24 5-5h-2c0 1.66-1.34 3-3 3s-3-1.34-3-3H7c0 2.76 2.24 5 5 5z"/></svg>';

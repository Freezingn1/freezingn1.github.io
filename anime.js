(function () {
    ...
    function createSubmenu() {
        ...
        var menuItems = [
            ...
            {
                name: Lampa.Lang.translate('anime_ongoing'),
        ...
        // Обработчики событий
        $('body').on('hover:enter', '[data-action="anime"]', function() {
            toggleSubmenu(true);
        });
    ...
    function setupSettings() {
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: {
                name: Lampa.Lang.translate('anime_title'),
                description: "Показывать раздел Аниме в главном меню"
            },
            onChange: function (value) {
                ...
                Lampa.Storage.set('anime_section', value);
            }
        });
    }
    ...
    function initPlugin() {
        ...
        var checkMenuInterval = setInterval(function() {
            if (Lampa.Menu.render().length) {
                ...
                if (Lampa.Storage.get('anime_section', 'true') === 'true') {
                    addMenuButton();
                    createSubmenu();
                }
            }

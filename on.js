function() {
    ...
    var Defined = {
        api: 'lampac',
        localhost: 'https://online.lampishe.cc/',
        apn: 'https://apn.watch/'
    };
    ...
    function component(object) {
        ...
        var balansers_with_search = ["kinobase", "rezka", "voidboost", "videocdn", "videodb", "collaps", "hdvb", "zetflix", "kodik", "ashdi", "eneyida", "kinokrad", "kinotochka", "kinoprofi", "lostfilmhd", "iframevideo", "cdnmovies", "anilibria", "animedia", "animego", "animevost", "animebesst", "redheadsound", "videoapi", "bazon", "alloha", "seasonvar", "kinopub", "vokino"];
        ...
        this.contextMenu = function(params) {
            params.html.on('hover:long', function() {
                function show(extra) {
                    ...
                    menu.push({
                        title: Lampa.Lang.translate('player_lauch') + ' - Ð’ÑÑ‚Ñ€Ð¾ÐµÐ½Ð½Ñ‹Ð¹',
                        player: 'lampa'
                    });
                    menu.push({
    ...
    function startPlugin() {
        ...
        var manifst = {
            type: 'video',
            version: '1.2.3',
            name: 'ÐžÐ½Ð»Ð°Ð¹Ð½ Ð¿Ñ€Ð¾ÑÐ¼Ð¾Ñ‚Ñ€',
        ...
        function resetTemplates() {
            ...
            &lt;div class="online-prestige online-prestige--folder selector"&gt;
                &lt;div class="online-prestige__folder"&gt;
                    &lt;svg viewBox="0 0 128 112" fill="none" xmlns="https://www.w3.org/2000/svg"&gt;
            ...
            &lt;div class="online-prestige online-prestige-watched selector"&gt;
                ...
                &lt;div class="online-prestige-watched__body"&gt;
                    &lt;!-- Ð—Ð´ÐµÑÑŒ Ð¼Ð¾Ð¶ÐµÑ‚ Ð±Ñ‹Ñ‚ÑŒ ÐºÐ°ÐºÐ¾Ð¹-Ñ‚Ð¾ ÐºÐ¾Ð½Ñ‚ÐµÐ½Ñ‚ --&gt;
                &lt;/div&gt;
            &lt;/div&gt;`);
        }

        var button = `&lt;div class="full-start__button selector watch--lampishe lampac--button" data-subtitle="${manifst.name}"&gt;
    &lt;?xml version="1.0" encoding="utf-8"?&gt;
&lt;svg viewBox="0 0 2000 2000" style="enable-background:new 0 0 512 512" xmlns="http://www.w3.org/2000/svg"&gt;
  &lt;g&gt;
    &lt;path d="M 1258.914 376.5 L 741.088 376.5 C 396.733 376.5 117.588 655.645 117.588 1000 C 117.588 1344.355 396.733 1623.5 741.088 1623.5 L 1258.914 1623.5 C 1603.269 1623.5 1882.413 1344.355 1882.413 1000 C 1882.413 655.645 1603.269 376.5 1258.914 376.5 Z M 1415.869 1032.751 L 800.714 1387.909 C 794.865 1391.288 788.335 1392.976 781.805 1392.976 C 775.276 1392.976 768.746 1391.288 762.897 1387.909 C 751.198 1381.152 743.987 1368.672 743.987 1355.158 L 743.987 644.841 C 743.992 615.732 775.503 597.54 800.714 612.092 L 1415.869 967.25 C 1427.567 974.007 1434.777 986.486 1434.777 1000 C 1434.777 1013.514 1427.567 1025.993 1415.869 1032.751 Z" opacity="1" data-original="currentColor" fill="currentColor";"/&gt;
  &lt;/g&gt;
&lt;/svg&gt;
    
        &lt;span&gt;Ð¡Ð¼Ð¾Ñ‚Ñ€ÐµÑ‚ÑŒ&lt;/span&gt;
    &lt;/div&gt;`; // Ð½ÑƒÐ¶Ð½Ð° Ð·Ð°Ð³Ð»ÑƒÑˆÐºÐ°, Ð° Ñ‚Ð¾ Ð¿Ñ€Ð¸ ÑÑ‚Ñ€Ð°Ñ‚Ðµ Ð»Ð°Ð¼Ð¿Ñ‹ Ð³Ð¾Ð²Ð¾Ñ€Ð¸Ñ‚ Ð¿ÑƒÑÑ‚Ð¾
        ...
        Lampa.Listener.follow('full', function(e) {
            if (e.type == 'complite') {
                setTimeout(function() {
                    // Check if the button already exists and if the parent container is present
                    if ($(".watch--lampishe").length &lt;= 1 &amp;&amp; $(".watch--lampishe", Lampa.Activity.active().activity.render()).length) {
                        $(".watch--lampishe", Lampa.Activity.active().activity.render()).empty().append(`
              ...
              &lt;/svg&gt;
                      ...
                      &lt;span&gt;Ð¡Ð¼Ð¾Ñ‚Ñ€ÐµÑ‚ÑŒ&lt;/span&gt;`);
                        if (Lampa.Storage.get('card_interfice_type') === 'new') {
                            if ($('.watch--lampishe').lenght &gt; 1) $('.watch--lampishe')[1].remove()
                            $('.watch--lampishe').insertBefore($('.view--torrent'));
        ...
        Lampa.Component.add('lampac', component); //Ñ‚Ð¾ Ð¶Ðµ ÑÐ°Ð¼Ð¾Ðµ
        resetTemplates();
        ...
        if (Lampa.Manifest.app_digital &gt;= 177) {
            var balansers_sync = ["kinobase", "rezka", "voidboost", "videocdn", "videodb", "collaps", "hdvb", "zetflix", "kodik", "ashdi", "eneyida", "kinokrad", "kinotochka", "kinoprofi", "lostfilmhd", "iframevideo", "cdnmovies", "anilibria", "animedia", "animego", "animevost", "animebesst", "redheadsound", "videoapi", "bazon", "alloha", "seasonvar", "kinopub", "vokino"];

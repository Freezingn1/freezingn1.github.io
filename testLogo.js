                    ...
                    fetchRussianTitle(movie).then(title => {
                        if (title && render && render.find) {
                            ...
                            if (rateLine && rateLine.length) {
                                rateLine.before(`
                                    <div class="ru-title-full" style="color: #ffffff; font-weight: 500; text-align: right; margin-bottom: 10px; opacity: 0.80; max-width: 15em;text-shadow: 1px 1px 0px #0000007a;">
                                        RU: ${title}
                                    </div>
                                `);
                            }

(function() {
  ...
  if (!window.rch) {
    Lampa.Utils.putScript(["http://vcdn2.skaz.tv/invc-rch.js"], function() {}, false, function() {
      if (!window.rch.startTypeInvoke)
        window.rch.typeInvoke('http://vcdn2.skaz.tv', function() {});
    }, true);
  }
  ...
  if (!window.lampac3_plugin) startPlugin();

(function () {
    ...
    function component(object) {
        ...
        this.build = function (data) {
            ...
            modalCloseHandler = function(e) {
                if ($(e.target).closest('.modal__content').length && 
                    Lampa.Controller.active().link !== this) {
                    this.back();
                }
            }.bind(this);
        ...
        this.back = function () {
            ...
            // Закрываем все модальные окна перед возвратом
        ...
        this.down = function () {
            if (isDestroyed || $('.modal__content:visible').length > 0) return;
        ...
        this.start = function () {
            ...
            // Закрываем все модальные окна перед стартом
            $('.modal__content').remove();
            ...
            Lampa.Controller.add('content', {
                ...
                toggle: function toggle() {
                    ...
                    if ($('.modal__content:visible').length > 0) {
                        $('.modal__content').remove();
                        return true;
                    }

(function () {
    ...
    function add() {
        ...
        // Имя параметра
        var paramName = 'reload_button_enabled';
        ...
        Lampa.SettingsApi.addParam({
            ...
            onChange: function(value) {
                ...
                Lampa.Storage.set('settings', paramName, value);
        ...
        function updateButtonVisibility() {
            var isEnabled = Lampa.Storage.get('settings', paramName, true);
            if (isEnabled) {
        ...
        // Создаем кнопку
        var isEnabled = Lampa.Storage.get('settings', paramName, true);
        var my_reload = '<div id="RELOAD" class="head__action selector reload-screen' + (isEnabled ? '' : ' hide') + '">' +

(function () {
    ...
    function add() {
        ...
        var reloadSetting = Lampa.SettingsApi.addParam({
            component: 'Multi_Menu_Component',
            param: {
                name: 'Reloadbutton',
                type: 'trigger',

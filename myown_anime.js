      ...
      var SourceTMDB = function (parrent) {
        ...
        this.main = function () {
		  ...
		  // Популярные аниме 2020–2026 с высоким рейтингом
           ...
           // Новинки
            function (call) {
              owner.get('discover/movie?with_genres=16&without_genres=10762&with_keywords=210024|287501&with_origin_country=JP&with_origin_country=CN&sort_by=primary_release_date.desc&vote_average.gte=5&vote_count.gte=2', params, function (json) {
            ...
            // Новинки Сериалы
            function (call) {
              owner.get('discover/tv?with_genres=16&without_genres=10762&with_keywords=210024|287501&with_origin_country=JP&with_origin_country=CN&sort_by=first_air_date.desc&vote_average.gte=5&vote_count.gte=2', params, function (json) {

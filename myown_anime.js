      ...
      var SourceTMDB = function (parrent) {
        ...
        this.main = function () {
		  ...
		  // Популярные сериалы 2020–2026 с высоким рейтингом
            function (call) {
              owner.get('discover/tv?with_original_language=ja|zh|ko|en&with_genres=16&without_genres=10762&first_air_date.gte=2020-01-01&first_air_date.lte=2026-12-31&sort_by=popularity.desc&vote_average.gte=7.0&vote_count.gte=25&with_keywords=210024', params, function (json) {
            ...
            function (call) {
              owner.get('discover/movie?with_original_language=ja|zh|ko|en&with_genres=16&without_genres=10762&first_air_date.gte=2020-01-01&first_air_date.lte=2026-12-31&sort_by=popularity.desc&vote_average.gte=7.0&vote_count.gte=25&with_keywords=210024', params, function (json) {
           ...
           // Новинки
            function (call) {
              owner.get('discover/movie?with_original_language=ja&with_genres=16&without_genres=10762&with_keywords=210024|287501&sort_by=primary_release_date.desc&vote_average.gte=7&vote_average.lte=9.6&vote_count.gte=2', params, function (json) {
            ...
            // Новинки Сериалы
            function (call) {
              owner.get('discover/tv?with_original_language=ja&with_genres=16&without_genres=10762&with_keywords=210024|287501&sort_by=first_air_date.desc&vote_average.gte=7&vote_average.lte=9.6&vote_count.gte=2', params, function (json) {

        ...
        this.main = function () {
		  ...
		  // Популярные сериалы 2020–2026 с высоким рейтингом
           ...
           // Новинки
            ...
            // Новинки Сериалы
            function (call) {
              owner.get('discover/tv?with_original_language=ja&with_genres=16&without_genres=10762&with_keywords=210024|287501&first_air_date.desc&vote_average.gte=6&vote_count.gte=5', params, function (json) {

      ...
      var SourceTMDB = function (parrent) {
        ...
        this.main = function () {
		  ...
		  // Популярные сериалы 2020–2026 с высоким рейтингом
			...
			// Онгоинги
            function (call) {
              owner.get('discover/tv?with_original_language=ja&with_genres=16&without_genres=10762&with_keywords=210024|287501&with_status=Returning Series&&air_date.gte=2026-01-01&sort_by=vote_average.desc&vote_average.gte=6&vote_average.lte=9.6&vote_count.gte=5', params, function (json) {
                json.title = 'Онгоинги';

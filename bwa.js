(function() {
  ...
  // Убираем вызов account(), чтобы не превращало в proxyimg
  // if (elem.img.indexOf('/proxyimg') !== -1)
  //     elem.img = account(elem.img);

  // Сразу проксируем прямой URL через твой worker

(function() {
    ...
    const CLICK_DELAY = 3000;    // Задержка перед кликом (увеличено с 300 до 800 мс)
    const INITIAL_DELAY = 6000; // Первая проверка через 1.5 сек после загрузки (увеличено с 1000)

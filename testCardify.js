  ...
  function startPlugin() {
    ...
    Lampa.Listener.follow('full', function (e) {
      if (e.type == 'complete') {
        ...
        // Добавляем оценку TMDB
        if(e.data.vote_average) {
          const rating = Math.round(e.data.vote_average * 10) / 10;
          const ratingElement = e.object.activity.render().find('.tmdb-rating__value');

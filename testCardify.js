(function () {
  ...
  function startPlugin() {
        ...
        <div class="full-start-new__body">
            ...
            <div class="full-start-new__right">
                ...
                <div class="cardify__right">
                    <!-- Добавлен блок с рейтингом TMDB -->
                    <div class="full-start-new__rate">
                        <div class="full-start__pg">
                            ...
                            <span class="full-start__pg-value">{vote_average}</span>
                        </div>
                    </div>
    ...
    .full-start-new__rate-line .full-start__pg {font-size: 0.9em;} 
    .full-start__background {left: 0em; top: -5em; height: 109%;} 
    .full-start__background.loaded {opacity: 0.8;} 
    .full-start-new__title {font-weight: 800; font-size: 3em;} 
    .full-start-new__title {margin-top: 0.1em;} 
    .full-start-new__head {font-size: 1.1em;} 
    .full-start-new__title.twolines {-webkit-line-clamp: 4; max-width: 12em; margin-top: 0.1em; text-shadow: 2px 3px 1px #00000040; margin-bottom: 0.2em; line-height: 1; font-size: 3em; word-spacing: 5px; letter-spacing: -2px; text-transform: uppercase;} 
    ...
    .cardify .full-start-new__title{text-shadow: 2px 3px 1px #00000040;} 
    ...
    @-webkit-keyframes animation-full-background{0%{-webkit-transform:translate3d(0,-10%,0);transform:translate3d(0,-10%,0)}100%{-webkit-transform:translate3d(0,0,0);transform:translate3d(0,0,0)}}
    @-moz-keyframes animation-full-background{0%{-moz-transform:translate3d(0,-10%,0);transform:translate3d(0,-10%,0)}100%{-moz-transform:translate3d(0,0,0);transform:translate3d(0,0,0)}}
    @-o-keyframes animation-full-background{0%{transform:translate3d(0,-10%,0)}100%{transform:translate3d(0,0,0)}}
    @keyframes animation-full-background{0%{-webkit-transform:translate3d(0,-10%,0);-moz-transform:translate3d(0,-10%,0);transform:translate3d(0,-10%,0)}100%{-webkit-transform:translate3d(0,0,0);-moz-transform:translate3d(0,0,0);transform:translate3d(0,0,0)}}
    @-webkit-keyframes animation-full-start-hide{0%{-webkit-transform:translate3d(0,0,0);transform:translate3d(0,0,0);opacity:1}100%{-webkit-transform:translate3d(0,50%,0);transform:translate3d(0,50%,0);opacity:0}}
    @-moz-keyframes animation-full-start-hide{0%{-moz-transform:translate3d(0,0,0);transform:translate3d(0,0,0);opacity:1}100%{-moz-transform:translate3d(0,50%,0);transform:translate3d(0,50%,0);opacity:0}}
    @-o-keyframes animation-full-start-hide{0%{transform:translate3d(0,0,0);opacity:1}100%{transform:translate3d(0,50%,0);opacity:0}}
    @keyframes animation-full-start-hide{0%{-webkit-transform:translate3d(0,0,0);-moz-transform:translate3d(0,0,0);transform:translate3d(0,0,0);opacity:1}100%{-webkit-transform:translate3d(0,50%,0);-moz-transform:translate3d(0,50%,0);transform:translate3d(0,50%,0);opacity:0}}
    </style>
    `;
    ...
    Lampa.Listener.follow('full', function (e) {
      if (e.type == 'complete') {
        ...
        // Добавляем рейтинг TMDB
        if(e.data.vote_average) {
          let rating = Math.round(e.data.vote_average * 10) / 10;
          e.object.activity.render().find('.full-start__pg-value').text(rating);
        }
      }
    });
  }

(function () {
    ...
    function startPlugin() {
        ...
        // Создаем группу "Стильный интерфейс" в разделе "Интерфейс"
        Lampa.SettingsApi.addParam({
            component: 'interface',
            param: {
                name: 'stylish_interface_group',
                type: 'group',
        ...
        // Добавляем параметры в новую группу
        Lampa.SettingsApi.addParam({
            component: 'interface',
            param: {
    ...
    // Запускаем плагин с проверкой версии Lampa
    if (Lampa && Lampa.SettingsApi && !window.plugin_interface_ready) {
        startPlugin();
    } else {
        setTimeout(function() {

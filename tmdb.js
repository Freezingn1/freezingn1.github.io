(function () {
    ...
    var tmdb = {
        ...
        path_image: Lampa.Utils.protocol() + 'tmdbimg.kurwa-bober.ninja/',
        path_api: Lampa.Utils.protocol() + 'tmdbapi.kurwa-bober.ninja/3/'
    };
    var imageDomains = [
        'image.tmdb.org',
        'tmdbimg.kurwa-bober.ninja',
        'imagetmdb.com'
    ];
    var apiDomains = [
        'api.themoviedb.org',
        'tmdbapi.kurwa-bober.ninja',
    ...
    if (!disablePlugin) {
        ...
        for (var i=0; i < plugins.length; i++) {
            ...
            if (plugins[i].url.indexOf('.kurwa-bober.ninja/tmdb.js') > 0) {
